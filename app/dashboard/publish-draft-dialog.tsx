  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button size="icon" variant="outline" className="h-8 w-8" title="Publish draft">
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Publishing will make the agreement active and apply your signature. Optional: provide an
            email to invite the other party immediately.
          </DialogDescription>
        </DialogHeader>
